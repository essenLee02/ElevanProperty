...
>
> You may name types **only** when the coverage/catalog data in your context shows the agent
...
> *"Saya tanya saja dulu"*. The bot answered by asking *"cash atau KPR ya, Kak? 💳"* — pushing
> its own agenda straight past a refusal.
