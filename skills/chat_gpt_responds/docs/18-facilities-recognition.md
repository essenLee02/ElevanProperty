...
**For ChatGPT API:**
- Load all 273 facilities into context during conversation initialization
...
- Include emoji icons in customer-facing output

**For Claude API:**
- Include facility list in system prompt
- Use emoji for visual differentiation
- Maintain bilingual awareness throughout
- Normalize to English for backend storage
