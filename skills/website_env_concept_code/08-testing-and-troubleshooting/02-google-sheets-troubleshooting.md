...
If the sheet is blank, the current backend attempts to create the header automatically.

If the header exists but is incomplete, the backend returns a clear error.
