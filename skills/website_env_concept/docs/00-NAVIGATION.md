...
**Fonnte, ChakraHQ, TimelinesAI** (WATI/360dialog = legacy, di luar scope dok ini).

> Ringkasan 1-file untuk upload cepat: `../WEBSITE_ENV_CONCEPT_BRIEF.txt`.

---

## Files (urut 01–15, tanpa duplikat)
...
| 09 | `09-whatsapp-terminal-multiagent.md` | Terminal multi-agent: Fonnte + ChakraHQ + TimelinesAI, MASSEGE_TERMINAL, gate, routing |
...
- **AI memproses pesan?** → 06 (AI system) → 10 (kualifikasi) → 11 (format balasan)
