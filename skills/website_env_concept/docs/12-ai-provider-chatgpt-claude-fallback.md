...
If ChatGPT fails because of billing, quota, rate-limit, API key, model, or connection issues, the backend should automatically send the same prompt to Claude.
