# 12 — Locations, Anchors & Landmarks
...
> A pre-filter may bypass its non-property blocklist (which contains "cafe",
...
> `KATALOG NYATA AGENT` block answers it. **Run the Q2 → Q2c gate in `03-qualification-flow.md`
...
>    catalog block, with consent (doc 03 §Q2d). `MERR` and `Wiyung` reached a customer this
...
- `03-qualification-flow.md` — Q2c/Q6 wording, the Q5↔Q6 split, summary field rules
- `11-facilities-reference.md` — the facilities counterpart of this reference
- `07-catalog-and-recommendations.md` — how anchors feed catalog ranking
