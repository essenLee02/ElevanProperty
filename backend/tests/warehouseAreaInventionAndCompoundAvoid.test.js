 ...
 *    HANYA ada di skill doc sendiri (02-qualification-flow.md) sebagai
...
folders.forEach((folder) => {
  const docPath = path.join(PROJECT_ROOT, 'skills', folder, 'docs', '02-qualification-flow.md');
...
const claudeDoc = fs.readFileSync(path.join(PROJECT_ROOT, 'skills', 'claude_responds', 'docs', '02-qualification-flow.md'), 'utf8');
const chatgptDoc = fs.readFileSync(path.join(PROJECT_ROOT, 'skills', 'chat_gpt_responds', 'docs', '02-qualification-flow.md'), 'utf8');
ok('claude_responds & chat_gpt_responds doc 02 BYTE-IDENTICAL (aturan wajib proyek)',
...
const claudeDoc2 = fs.readFileSync(path.join(PROJECT_ROOT, 'skills', 'claude_responds', 'docs', '02-qualification-flow.md'), 'utf8');
const chatgptDoc2 = fs.readFileSync(path.join(PROJECT_ROOT, 'skills', 'chat_gpt_responds', 'docs', '02-qualification-flow.md'), 'utf8');
