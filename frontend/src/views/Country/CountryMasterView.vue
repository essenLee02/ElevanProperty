...
.master-form input:focus { border-color: #667eea; box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.15); }
.master-form input:disabled { background: #edf2f7; cursor: not-allowed; color: #718096; }
